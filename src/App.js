...
export default function App() {
    ...
    useEffect(() => {
        GoogleSignin.configure({
            webClientId: '89516330676-eiomtdgslkrahr0hvssaseea4hobrpkt.apps.googleusercontent.com',
        });
    }, []);
    async function onGoogleButtonPress() {
        try {
            ...
            if (user.email.indexOf('@iiitdmj.ac.in') > -1) {
                ...
                return ToastAndroid.show('Only institute Email ID allowed. Try again!', ToastAndroid.SHORT);
            }
        }
        catch (err) {
