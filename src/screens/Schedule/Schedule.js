            ...
            <ScrollView>
                ...
                {activeIndex === 0 ?
                    <><Text style={styles.heading}>Bus - 1 (MP20PA7297)</Text>
                        ...
                        <ScheduleTable tableHead={ScheduleData.mon_fri.bus2.tableHead} tableData={ScheduleData.mon_fri.bus2.tableData} /></> :
                    <><Text style={styles.heading}>Bus - 1 (MP20PA7297)</Text>
                        <ScheduleTable tableHead={ScheduleData.sat_sun.bus1.tableHead} tableData={ScheduleData.sat_sun.bus1.tableData} />
                        <Text style={styles.heading}>Bus - 2 (MP20PA6297)</Text>
                        <ScheduleTable tableHead={ScheduleData.sat_sun.bus2.tableHead} tableData={ScheduleData.sat_sun.bus2.tableData} /></>
                }
            </ScrollView>
