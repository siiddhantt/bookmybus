  ...
  return (
    <View style={styles.navBar}>
      <Pressable
        ...
        <Text
          style={[
            currentScreen === 'HomePage' ? styles.whiteText : styles.blackText,
            styles.txt,
          ]}>
          Home
        </Text>
      ...
      <Pressable
        ...
        <Text
          style={[
            currentScreen === 'Schedule' ? styles.whiteText : styles.blackText,
            styles.txt,
          ]}>
          Schedule
        </Text>
      ...
      <Pressable
        ...
        <Text
          style={[
            currentScreen === 'Account' ? styles.whiteText : styles.blackText,
            styles.txt,
          ]}>
          Account
        </Text>
